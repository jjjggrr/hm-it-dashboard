export const series = {
  ...
  AverageAPIResponseTime: {
    ...
    Data: {
      Hub1: [ 148.3, 210.5, 89.1, 450.7, 221.6, 178.4, 66.2, 112.9, 123.0, 288.1, 155.5, 223.7, ],
      Hub2: [ 162.1, 77.8, 245.3, 411.2, 134.9, 389.0, 58.7, 599.3, 199.6, 290.4, 495.1, 140.2, ],
      Hub3: [ 151.4, 18.9, 288.6, 433.0, 95.8, 167.3, 222.5, 477.7, 130.1, 345.9, 112.4, 399.8, ],
      Hub4: [ 205.2, 333.6, 119.7, 466.8, 678.0, 42.1, 173.5, 267.4, 145.9, 376.2, 83.3, 191.0, ],
    },
    TimeUnits: ["D", "W", "M", "Y"],
    DefaultUnit: "W",
  },
  AcceptanceRate: {
    ...
    Data: {
      ...
      Hub3: [4.2, 3.9, 4.7, 3.3, 4.1, 1.9, 4.6, 3.5, 4.8, 3.2, 4.4, 3.4],
      Hub4: [3.7, 4.9, 3.2, 4.5, 4.0, 3.6, 4.3, 3.8, 4.1, 3.4, 4.7, 4.2],
    },
    TimeUnits: ["W", "M", "Y"],
    DefaultUnit: "W",
  },
